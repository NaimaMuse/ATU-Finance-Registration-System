...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $checkQuery = "SELECT * FROM tblmasterstudents WHERE Email = :email OR MobileNumber = :phone";
    ...
    if (empty($errors)) {
        try {
            $sql = 'INSERT INTO tblmasterstudents (FullName, DateOfBirth, Address, Email, MobileNumber, faculty_enrolled)
            ...
            $stmt->execute();
            header('Location: ./master_students.php');
            exit;
    ...
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <div class="faculty-selection">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="radio" name="faculty" value="Master in project planning & management"> Master in Project Planning & Management<br>
