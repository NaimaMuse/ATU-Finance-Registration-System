...
// Enable error reporting for debugging (uncomment in development)
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $searched = '%' . $_GET['search'] . '%'; // Append wildcards for LIKE query
    try {
        // Combined query using UNION ALL, adding a column to specify "Degree" or "Master"
        $sql = '
            SELECT 
                StudentID, 
                FullName, 
