...
if (isset($_POST['action']) && isset($_POST['student_id'])) {
    ...
    $sql = "UPDATE tblmasterstudents SET payment_status = :payment_status WHERE StudentID = :studentID";
...
$sql = "SELECT * FROM tblmasterstudents";
...
<body>
    ...
    <div class="container">
        <h1>Master Payment Verification</h1>
